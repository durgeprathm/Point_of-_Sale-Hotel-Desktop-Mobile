...
//  Product.copyWith("Wheat",20,250,2,"27/10/20","28/10/20",0),
  ...
  double getGSTAmount(Product product){
  ...
  double getBasicAmount(Product product){
    double GSTamount = product.gstperce;
    double sellingPrice = (product.productprice) * (product.productquntity);
    double mainPrice = sellingPrice / (100 + GSTamount) * 100;
    return mainPrice;
  ...
  int fungetFinalSubtotalminus(Product product){
...
//  }
  ...
  void increaseQuant(Product product) {
    product.increaseQuanity();
    print('Here I am Inside inc');
    notifyListeners();
  }

  void decreaseQuant(Product product) {
    product.decreaseQuanity();
    notifyListeners();
  }

  void updateSTotal(Product product){
...
//    notifyListeners();
//  }
  void deleteTask(Product product) {
