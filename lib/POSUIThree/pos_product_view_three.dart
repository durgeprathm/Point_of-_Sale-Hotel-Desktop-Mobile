...
class POSProductViewerThree extends StatefulWidget {
  @override
  _POSProductViewerThreeState createState() => _POSProductViewerThreeState();
}

class _POSProductViewerThreeState extends State<POSProductViewerThree> {
    ...
    return Expanded(
      ...
      return Container(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      Provider.of<ProductDataTrialThree>(context,
                                              listen: false)
                                          .addProduct(product);
                                      Navigator.of(context).pop();
                                      subtotaltextEC.text = "";
          ...
          Expanded(
            child:
                Consumer<ProductDataTrialThree>(builder: (context, productData, child) {
              return Container(
