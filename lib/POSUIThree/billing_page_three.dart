...
class BillingScreenThree extends StatefulWidget {
  BillingScreenThree(this.billingAmount, this.DATE);

  final double billingAmount;
  final String DATE;

  @override
  _BillingScreenThreeState createState() => _BillingScreenThreeState();
}

class _BillingScreenThreeState extends State<BillingScreenThree> {
