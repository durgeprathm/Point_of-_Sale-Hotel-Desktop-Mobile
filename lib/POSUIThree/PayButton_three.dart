...
import 'billing_page_three.dart';
import 'package:retailerp/POSUIThree/billing_productdata_trial_three.dart';

class PayButtonThree extends StatefulWidget {

  PayButtonThree(this.CustomerName,this.Date);
  final String CustomerName;
  final String Date;
  @override
  _PayButtonThreeState createState() => _PayButtonThreeState();
}

class _PayButtonThreeState extends State<PayButtonThree> {


  @override
  Widget build(BuildContext context) {
    return Consumer<ProductDataTrialThree>(builder: (context, productData, child) {
      return  Padding(
                    ...
                    builder: (context) =>
                        SingleChildScrollView(
                            child: Container(
                              ...
                              child: BillingScreenThree(productData.totalAmount1,widget.Date),
                            )
                        )
                );
              }
