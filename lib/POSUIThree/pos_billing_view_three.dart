...
import 'package:retailerp/POSUIThree/pos_billing_list_three.dart';
import 'package:retailerp/POSUIThree/PayButton_three.dart';
...
class POSBillingViewThree extends StatefulWidget {

  @override
  _POSBillingViewThreeState createState() => _POSBillingViewThreeState();
}

class _POSBillingViewThreeState extends State<POSBillingViewThree> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Provider.of<ProductDataTrialThree>(context, listen: false)
                          .ClearTask();
                    },
            ...
            PayButtonThree(CustomerName,_selectdate.toString()),
          ],
        ),
      ),
    );
