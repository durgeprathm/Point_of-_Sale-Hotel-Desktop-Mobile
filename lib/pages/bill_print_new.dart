...
class BillPrintNew extends StatefulWidget {
  ...
  @override
  _BillPrintNewState createState() => _BillPrintNewState();
}

class _BillPrintNewState extends State<BillPrintNew> {
                  ...
                  pw.Container(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          pw.Text('GSTIN No:${ShopDetails[0].shopgstnumber}')
                        ],
                      ))
                  // pw.SizedBox(
                  //   width: 20.0
