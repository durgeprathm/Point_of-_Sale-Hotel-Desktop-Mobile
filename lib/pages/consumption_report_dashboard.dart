...
import 'consumption_Todays_reports.dart';
import 'consumption_overAll_reports.dart';

class ConsumptionReportDashboard extends StatefulWidget {
  @override
  _ConsumptionReportDashboardState createState() => _ConsumptionReportDashboardState();
}

class _ConsumptionReportDashboardState extends State<ConsumptionReportDashboard> {
  @override
  //-------------------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    if (shortestSide < kTabletBreakpoint) {
      content = _buildMobileConsumptionReportDashboard();
    } else {
      content = _buildTabletConsumptionReportDashboard();
    }
  ...
  //-------------------------------------------
  //---------------Tablet Mode Start-------------//
  Widget _buildTabletConsumptionReportDashboard() {
    return Scaffold(
...
//              mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.of(context)
                            ...
                            return ConsumptionTodayReports();
                          }));
                        },
                        child: Material(
                          color: POSBG,
                    ...
                    Expanded(
                      child: GestureDetector(
                        onTap: () {
                          Navigator.of(context)
                              .push(MaterialPageRoute(builder: (_) {
                            return ConsumptionOverAllReports();
                          }));
                        },
                        child: Material(
                          color: SALESBG,
  ...
  //---------------Tablet Mode End-------------//
  //---------------Mobile Mode Start-------------//
  Widget _buildMobileConsumptionReportDashboard() {
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        title: Row(
