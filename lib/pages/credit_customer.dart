...
class CreditCustomer extends StatefulWidget {
  @override
  _CreditCustomerState createState() => _CreditCustomerState();
}
...
class _CreditCustomerState extends State<CreditCustomer> {
  ...
  Widget appBarTitle = Text("Manage Credit Customer");
        ...
        actions: [
          ...
          new PopupMenuButton(
            ...
            itemBuilder: (BuildContext context) {
              return customerPopupMenu3.map((PopupMenu popupMenu) {
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text("${searchCustomerList[index].date}",
  ...
  void updateListView() {
    ...
    dbFuture.then((value) {
      Future<List<CustomerModel>> todoListFuture =
          databaseHelper.getCreditCustomerList('CR');
