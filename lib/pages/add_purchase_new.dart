...
class AddPurchaseNew extends StatefulWidget {
  @override
  _AddPurchaseNewState createState() => _AddPurchaseNewState();
}

class _AddPurchaseNewState extends State<AddPurchaseNew> {
...
//---------------Tablet Mode Start-------------//
                                ...
                                Navigator.of(context)
                                    .push(MaterialPageRoute(
                                        builder: (context) =>
                                            AddSupplierDetails()))
                                    .then(
                                        (value) => _reloadSupplierList(value));
                              },
                            ),
                            SizedBox(
                              width: 15,
                              ...
                              onPressed: () {
                                Navigator.of(context)
                                    .push(MaterialPageRoute(
                                        builder: (context) =>
                                            AddProductScreen()))
                                    .then((value) => _reloadProduct(value));
                              },
                            ),
                            Expanded(
                              child: Padding(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        labelText: 'Invoice No *',
                        errorText:
                            _pInvoiceNOvalidate ? 'Enter Invoice No' : null,
                      ),
                    ),
                    SizedBox(
                      height: 10,
  ...
  void uploadData(cart) async {
    ...
    if (pCompanyName.isNotEmpty) {
      ...
      // insert on server
      var result = await purchaseinsert.getpospurchaseinsertWithIds(
          pCompanyID,
      ...
      _showMyDialog('Filed Select supplier company name!', Colors.red);
      Fluttertoast.showToast(
  ...
  _reloadProduct(value) {
    _getProducts();
  }

  _reloadSupplierList(value) {
    _getSupplier();
  }
