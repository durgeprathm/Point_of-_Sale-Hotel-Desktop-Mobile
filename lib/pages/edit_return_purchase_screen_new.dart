...
class EditReturnPurchaseScreenNew extends StatefulWidget {
  EditReturnPurchaseScreenNew(this.indexFetch, this.purchaseList);

  @override
  final int indexFetch;
  List<Purchase> purchaseList = new List();

  _EditReturnPurchaseScreenNewState createState() =>
      _EditReturnPurchaseScreenNewState(this.indexFetch, this.purchaseList);
}

class _EditReturnPurchaseScreenNewState extends State<EditReturnPurchaseScreenNew> {
  final int indexFetch;
  List<Purchase> purchaseList = new List();
  ...
  void initState() {
    setState(() {
      ...
      pCompanyName = purchaseList[indexFetch].PurchaseCompanyname;
      _pSubTotaltext.text =
  ...
  void uploadData(cart) async {
    if (pCompanyName.isNotEmpty) {
      ...
      // insert on server
      var result = await purchaseinsert.getReturnPurchaseUpdateWithIds(
          proRowId.toString(),
          JoinedProductIds,
          pCompanyName,
          ...
          _pSubTotaltext.text.toString(),
          _pDiscounttext.text.toString(),
          _pMiscellaneonsController.text.toString(),
          _pTotalAmounttext.text.toString(),
          pNarrationController.text.toString());
      if (result == null) {
