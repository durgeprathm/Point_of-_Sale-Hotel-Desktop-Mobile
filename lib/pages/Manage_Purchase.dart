...
import 'package:retailerp/Datatables/Manage_Purchase_Source.dart';
...
//---------------Tablet Mode Start-------------//
  Widget _buildTabletManagepurchase() {
    ...
    final _dtSource = ManagePurchaseDataTableSource(
        ManagePurchaseData: _model,
        context: context
    );
...
//---------------Mobile Mode Start-------------//
  ...
  DataRow getRow(int index) {
    ...
    return DataRow(cells: [
      ...
      DataCell(Center(
          child: Text(
              searchPurchaseList[index].PurchaseMiscellaneons.toString()))),
      DataCell(Center(
          child: Text(searchPurchaseList[index].PurchaseDiscount.toString()))),
      DataCell(Center(
