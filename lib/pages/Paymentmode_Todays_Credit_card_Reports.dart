...
class PaymentModeTodayCreditCardsReports extends StatefulWidget {
  @override
  _PaymentModeTodayCreditCardsReportsState createState() =>
      _PaymentModeTodayCreditCardsReportsState();
}

class _PaymentModeTodayCreditCardsReportsState
    extends State<PaymentModeTodayCreditCardsReports> {
  @override
  //-------------------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    if (shortestSide < kTabletBreakpoint) {
      content = _buildMobilePaymentModeTodayCreditCardsReports();
    } else {
      content = _buildTabletPaymentModeTodayCreditCardsReports();
    }
...
//-------------------------------------------
  ...
  void initState() {
    ...
    _getSales();
    _getTodaysCreditCardList(_selectdate);
  }

  //---------------Tablet Mode Start-------------//
  Widget _buildTabletPaymentModeTodayCreditCardsReports() {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Row(
          children: [
            ...
            Text('Today\'s Credit Cards Reports'),
          ],
        ),
        actions: [
          IconButton(
...
//---------------Tablet Mode End-------------//
//---------------Mobile Mode Start-------------//
  Widget _buildMobilePaymentModeTodayCreditCardsReports() {
    return Scaffold(
      backgroundColor: Colors.white,
      appBar: AppBar(
        title: appBarTitle,
...
//from server
  ...
  Future<void> _getTodaysCreditCardList(String date) async {
    TodayDebitCreditCardTypeFetch allcreditcardtypefetch =
        new TodayDebitCreditCardTypeFetch();
    var response = await allcreditcardtypefetch
        .getTodayDebitCreditCardTypeFetch("1", date);
    var creditsd = response["sales"];
    List<CreditTypeDetails> tempCountList = [];

    for (var n in creditsd) {
