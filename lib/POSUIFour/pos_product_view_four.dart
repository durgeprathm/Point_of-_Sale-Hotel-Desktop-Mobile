...
class POSProductViewerFour extends StatefulWidget {
  @override
  _POSProductViewerFourState createState() => _POSProductViewerFourState();
}

class _POSProductViewerFourState extends State<POSProductViewerFour> {
  ...
  Widget build(BuildContext context) {
    return Expanded(
        child: Consumer<ProductDataTrialFour>(builder: (context, productData, child) {
      return Container(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      Provider.of<ProductDataTrialFour>(context,
                                              listen: false)
                                          .addProduct(product);
                                      Navigator.of(context).pop();
                                      subtotaltextEC.text = "";
          ...
          Expanded(
            child:
                Consumer<ProductDataTrialFour>(builder: (context, productData, child) {
              return Container(
