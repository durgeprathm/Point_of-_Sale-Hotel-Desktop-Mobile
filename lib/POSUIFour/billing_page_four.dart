...
class BillingScreenFour extends StatefulWidget {
  BillingScreenFour(this.billingAmount, this.DATE);

  final double billingAmount;
  final String DATE;

  @override
  _BillingScreenFourState createState() => _BillingScreenFourState();
}

class _BillingScreenFourState extends State<BillingScreenFour> {
