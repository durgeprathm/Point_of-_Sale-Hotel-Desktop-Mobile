...
class PayButtonFour extends StatefulWidget {

  PayButtonFour(this.CustomerName,this.Date);
  final String CustomerName;
  final String Date;
  @override
  _PayButtonFourState createState() => _PayButtonFourState();
}

class _PayButtonFourState extends State<PayButtonFour> {
                    ...
                    builder: (context) =>
                        SingleChildScrollView(
                            child: Container(
                              ...
                              child: BillingScreenFour(productData.totalAmount1,widget.Date),
                            )
                        )
                );
              }
