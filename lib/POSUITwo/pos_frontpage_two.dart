...
class POSFrontPageTwo extends StatefulWidget {
  @override
  _POSFrontPageTwoState createState() => _POSFrontPageTwoState();
}

class _POSFrontPageTwoState extends State<POSFrontPageTwo> {
