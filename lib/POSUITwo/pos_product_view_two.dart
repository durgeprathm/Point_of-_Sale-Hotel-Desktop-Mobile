...
class _POSProductViewerTwoState extends State<POSProductViewerTwo> {
  ...
  Widget build(BuildContext context) {
    return Expanded(
        child: Consumer<ProductDataTrialTwo>(builder: (context, productData, child) {
      return Container(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      Provider.of<ProductDataTrialTwo>(context,
                                              listen: false)
                                          .addProduct(product);
                                      Navigator.of(context).pop();
                                      subtotaltextEC.text = "";
          ...
          Expanded(
            child:
                Consumer<ProductDataTrialTwo>(builder: (context, productData, child) {
              return Container(
