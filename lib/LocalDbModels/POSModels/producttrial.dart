...
class ProductTrial {
  ...
  ProductTrial(this._pid, this._productname, this._productcat, this._productprice,this._productquntity, this._productrecption,this._productexpirydate,this._isDeleted);

  ProductTrial.copyWith(this._pid,this._productname, this._productprice,this._productquntity,this._isDeleted,this._subTotal,this._finalSubtotal,this._gstperce);
...
//  }
  ...
  double get productquntity => _productquntity;

  set productquntity(double value) {
...
// Extract a Note object from a Map object
  ...
  ProductTrial.fromMapObject(Map<String, dynamic> map) {
    this._pid = map['pid'];
