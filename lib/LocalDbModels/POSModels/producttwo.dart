...
class ProductTwo {
  ...
  ProductTwo(this._pid, this._productname, this._productcat, this ._productprice,this._productquntity, this._productrecption,this._productexpirydate,this._isDeleted);

  ProductTwo.copyWith(this._productname, this._productcat, this._productprice,this._productquntity, this._productrecption,this._productexpirydate,this._isDeleted,this._subTotal,this._finalSubtotal,this._productimage,this._gstperce);
...
// Extract a Note object from a Map object
  ...
  ProductTwo.fromMapObject(Map<String, dynamic> map) {
    this._pid = map['pid'];
