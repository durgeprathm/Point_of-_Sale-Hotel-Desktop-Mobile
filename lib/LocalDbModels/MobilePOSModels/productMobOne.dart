...
//  String _productimage;
  ...
  ProductMobOne(this._pid, this._productname, this._productcat, this._productprice,this._productquntity, this._productrecption,this._productexpirydate,this._isDeleted);

  ProductMobOne.copyWith(this._productname, this._productcat, this._productprice,this._productquntity, this._productrecption,this._productexpirydate,this._isDeleted,this._subTotal,this._finalSubtotal);
//  Product.copyWith(this._productname, this._productcat, this._productprice,this._productquntity, this._subTotal,this._productimage);
...
// Extract a Note object from a Map object
  ...
  ProductMobOne.fromMapObject(Map<String, dynamic> map) {
    this._pid = map['pid'];
