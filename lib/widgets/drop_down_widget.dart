...
class DropDownWidget extends StatefulWidget {
  ...
  DropDownWidget(this.hintText, this.itemList, this.getDropDownValue, this.id,
      this.fieldSize);

  DropDownWidget.withType(this.hintText, this.itemList, this.getDropDownValue,
      this.id, this.fieldSize, this.rnType);
