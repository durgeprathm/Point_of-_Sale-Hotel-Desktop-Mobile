...
class OrderedItemModel {
  ...
  OrderedItemModel(this._pid, this._productname, this._productcat, this._productprice,this._productquntity, this._productrecption,this._productexpirydate,this._isDeleted);
  OrderedItemModel.copyWith(this._pid,this._productname, this._productprice,this._productquntity,this._isDeleted,this._subTotal,this._finalSubtotal,this._gstperce);
...
// Extract a Note object from a Map object
  ...
  OrderedItemModel.fromMapObject(Map<String, dynamic> map) {
    this._pid = map['pid'];
