...
class POSProductViewerFive extends StatefulWidget {
  @override
  _POSProductViewerFiveState createState() => _POSProductViewerFiveState();
}

class _POSProductViewerFiveState extends State<POSProductViewerFive> {
  ...
  Widget build(BuildContext context) {
    return Expanded(
        child: Consumer<ProductDataTrialFive>(builder: (context, productData, child) {
      return Container(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                actions: <Widget>[
                                  TextButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      Provider.of<ProductDataTrialFive>(context,
                                              listen: false)
                                          .addProduct(product);
                                      Navigator.of(context).pop();
                                      subtotaltextEC.text = "";
          ...
          Expanded(
            child:
                Consumer<ProductDataTrialFive>(builder: (context, productData, child) {
              return Container(
