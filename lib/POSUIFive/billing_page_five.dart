...
class BillingScreenFive extends StatefulWidget {
  BillingScreenFive(this.billingAmount, this.DATE);

  final double billingAmount;
  final String DATE;

  @override
  _BillingScreenFiveState createState() => _BillingScreenFiveState();
}

class _BillingScreenFiveState extends State<BillingScreenFive> {
