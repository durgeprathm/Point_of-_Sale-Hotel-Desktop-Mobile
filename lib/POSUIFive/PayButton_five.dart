...
import 'billing_page_five.dart';
import 'package:retailerp/POSUIFive/billing_productdata_trial_five.dart';

class PayButtonFive extends StatefulWidget {

  PayButtonFive(this.CustomerName,this.Date);
  final String CustomerName;
  final String Date;
  @override
  _PayButtonFiveState createState() => _PayButtonFiveState();
}

class _PayButtonFiveState extends State<PayButtonFive> {
                    ...
                    builder: (context) =>
                        SingleChildScrollView(
                            child: Container(
                              ...
                              child: BillingScreenFive(productData.totalAmount1,widget.Date),
                            )
                        )
                );
              }
