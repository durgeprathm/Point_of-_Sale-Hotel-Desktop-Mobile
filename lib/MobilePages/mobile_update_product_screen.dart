...
class MobileUpdateProductScreen extends StatefulWidget {
  final int indexFetch;
  List<ProductModel> pList = new List();

  MobileUpdateProductScreen(this.indexFetch, this.pList);

  @override
  _MobileUpdateProductScreenState createState() =>
      _MobileUpdateProductScreenState(this.indexFetch, this.pList);
}

class _MobileUpdateProductScreenState extends State<MobileUpdateProductScreen> {
  int indexFetch;
  List<ProductModel> pList = new List();
                    ...
                    children: [
                      ...
                      mCatTypeValueName != null
                          ? ProCatDropDownStringWidget.withValue(
                              ...
                              .45,
                              mCatTypeValueName)
                          : ProCatDropDownStringWidget(productCatList,
                  ...
                  Row(
                    children: [
                      ...
                      FlatButton(
                        ...
                        child: Text('Choose Image', style: flatbtnTextStyle),
