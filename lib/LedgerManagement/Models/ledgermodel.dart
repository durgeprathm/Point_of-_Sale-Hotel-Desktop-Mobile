...
class Supplier {
  ...
  factory Supplier.fromJson(String json) {
    var tagsJson = jsonDecode(json)['supplier'];
    if (tagsJson == null) return null;
    return Supplier.WithIdname(
      tagsJson["SupplierId"],
      tagsJson["SupplierCustomername"],
    );
  }
  ...
  String userAsString() {
    return '#${this._Supplierid} ${this._SupplierComapanyName}';
  }

  ///custom comparing function to check if two users are equal
  bool isEqual(Supplier model) {
    return this?._Supplierid == model?._Supplierid;
  }

  @override
  String toString() => _SupplierComapanyName;
}
