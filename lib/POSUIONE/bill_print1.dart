...
class BillPrint1 extends StatefulWidget {
  List<String> menuNames;
  List<double> menuRates;
  List<double> menuQuants;
  ...
  @override
  _BillPrint1State createState() => _BillPrint1State();
}

class _BillPrint1State extends State<BillPrint1> {
          ...
          return
            ...
            pw.Row(
              ...
              pw.Padding(
                ...
                child: pw.Text(
                  'Bill No: ${widget.billno.toString()}',
                  textAlign: pw.  TextAlign.center,
                  style: pw.TextStyle(fontSize: 6),
                ),
              ),
                ...
                return pw.Container(
                  child: pw.Row(
                    children: [
                      ...
                      //               children: [
                      //             pw.Text(
                      //                 widget.menuNames[index].toString(),
                      //                 style: pw.TextStyle(fontSize: 8)),
                      //           ])),
                      //       pw.Expanded(
                      //         flex: 2,
                      //             child: pw.Text(
                      //                 "${widget.menuRates[index].toString()}",
                      //                 style: pw.TextStyle(fontSize: 8)),
                      //       ),
                      //       pw.Expanded(
                      //           flex: 3,
            ...
            //           pw.Padding(
            //             padding: pw.EdgeInsets.fromLTRB(0, 0, 65, 0),
            //             child: pw.Text('${widget.discount.toString()}',
            //                 style: pw.TextStyle(fontSize: 8)),
            //           ),
            //         ]),
            //   ],
